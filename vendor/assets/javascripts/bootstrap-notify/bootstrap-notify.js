...
!function ($) {
  var Notification = function (element, options) {
    ...
    }else if( typeof this.$element.data("type") !== 'undefined' && this.$element.data("type").length > 0){
    ...
    if(this.options.closable)
      this.$note.prepend($('<button type="button" class="close" data-dismiss="alert">×</button>'))
